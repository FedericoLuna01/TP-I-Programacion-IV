...
export function GuideForm({ initialData, onSubmit }: GuideFormProps) {
	...
	const handleImageUpload = () => {
		...
		setValue("image", "/api/placeholder/640/360");
	};
									...
									<div className="space-y-4">
										<div className="flex items-center gap-2">
											...
											{formValues.difficulty && (
												<Badge variant="outline">{formValues.difficulty}</Badge>
											)}
										</div>
								...
								<CardContent className="space-y-4">
									<Form {...form}>
										...
										>
											...
											<Button type="submit">
												{initialData ? "Guardar Cambios" : "Publicar Guía"}
											</Button>
										</form>
									</Form>
								</CardContent>
							...
							<Card className="bg-gradient-card border-border/50">
								...
								<CardContent className="space-y-3 text-sm">
									<div className="flex gap-2">
										...
										<p>Usa títulos y subtítulos para organizar el contenido</p>
									</div>
									<div className="flex gap-2">
