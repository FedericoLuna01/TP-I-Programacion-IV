	...
	return (
	  ...
	  `}</style>
			...
			<div className="pointer-events-none absolute top-0 left-1/2 z-0 h-full w-full -translate-x-1/2 select-none overflow">
				<div className="absolute -top-32 left-1/4 h-72 w-72 rounded-full bg-primary-600/20 blur-3xl" />
			</div>
			<div className="glass relative mx-auto flex container flex-col items-center gap-8 rounded-2xl px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-12">
