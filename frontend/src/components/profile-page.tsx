...
import { getGuidesByUserId, type User } from "@/lib/mock-data";
		...
		<div className="py-20">
			<main className="container mx-auto">
				...
				<div className="relative mb-8">
					{/* Cover Image */}
					<div className={cn("h-48 md:h-64 rounded-md mb-6", user.banner)} />
					{/* Profile Info */}
				...
				<div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
					...
					<Card className="bg-gradient-card border-border/50">
						<CardContent className="p-6 text-center">
							<div className="flex items-center justify-center w-12 h-12 bg-emerald-500/20 rounded-full mx-auto mb-2">
					...
					<Card className="bg-gradient-card border-border/50">
						<CardContent className="p-6 text-center">
							<div className="flex items-center justify-center w-12 h-12 bg-gray-200/20 rounded-full mx-auto mb-2">
